...
module Dphones.Object.Mixen_avg_fields exposing (..)
...
index : SelectionSet (Maybe Float) Dphones.Object.Mixen_avg_fields
index =
    Object.selectionForField "(Maybe Float)" "index" [] (Decode.float |> Decode.nullable)


plays : SelectionSet (Maybe Float) Dphones.Object.Mixen_avg_fields
plays =
